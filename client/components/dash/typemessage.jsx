...
const TypeMessage = () => {
  ...
  return (
    <div className="flex h-10 p-2 gap-2 px-4 text-gray-600 bg-gray-500">
      <input
        className="bg-gray-200 grow px-2 rounded-md outline-none"
        id="message"
        value={messages}
      ...
      />
      <button
        className="bg-amber-400 font-semibold text-xs rounded-md px-2 transition-colors duration-200 hover:text-gray-800 hover:bg-amber-300"
        type="button"
        onClick={flood}
      >
        Send
